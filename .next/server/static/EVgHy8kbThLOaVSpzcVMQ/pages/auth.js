...
// EXTERNAL MODULE: ./components/User.module.scss
var User_module = __webpack_require__("geRl");
...
const user = props => __jsx("div", {
  className: User_module_default.a.Div
}, __jsx("h1", null, props.name), __jsx("p", null, "Age: ", props.age));
...
const authIndexPage = () => auth_jsx("div", null, auth_jsx("h1", null, "The auth index page"), auth_jsx(User, {
  name: "Niranjan",
  age: "28"
}));
